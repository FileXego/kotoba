...
export const ja = {
  ...
  "auth.duplicate": "ユーザー名またはメールアドレスが既に存在します",
  "auth.network": "ネットワークエラー",
  "auth.captcha": "認証を完了してください",
  "auth.captchaFail": "認証に失敗しました",
  ...
  "list.submitFail": "投稿に失敗しました",
  "reply.limit": "これ以上返信できません",
  "reply.notFound": "親メッセージが見つかりません",
  "time.justNow": "たった今",
  "time.minutesAgo": "分前",
  "time.hoursAgo": "時間前",
  "time.daysAgo": "日前",
  ...
  "admin.users": "ユーザー",
  "admin.restore": "復元",
  "admin.hardDelete": "完全削除",
  "admin.confirmDelete": "永久に削除しますか？",
...
export const zh: Record<Key, string> = {
  ...
  "auth.signUp": "注册",
  "auth.error": "用户名或密码错误",
  "auth.duplicate": "用户名或邮箱已存在",
  "auth.network": "网络错误",
  "auth.captcha": "请完成人机验证",
  "auth.captchaFail": "验证失败",
  ...
  "list.loadMore": "加载更多",
  "list.loadFail": "加载失败",
  "list.submitFail": "提交失败",
  "reply.limit": "无法继续回复",
  "reply.notFound": "找不到父留言",
  "time.justNow": "刚刚",
  "time.minutesAgo": "分钟前",
  "time.hoursAgo": "小时前",
  "time.daysAgo": "天前",
